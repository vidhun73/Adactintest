...
public class Mini_baseclass {
	...
	public static void Singledrop(WebElement element,String single, String value) {
		...
		} else if(single.equalsIgnoreCase("index")) {
...
File location1 = new File("C:\\Users\\vidhun ck\\eclipse-workspace\\miniproject\\screenshot\\photo.png");
